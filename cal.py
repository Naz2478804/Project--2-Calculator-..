...
btn_multi =Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="*",command=lambda:buttonClick("*"))
...
btn_divide =Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="/",command=lambda:buttonClick("/"))
...
btn_point =Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text=".",command=lambda:buttonClick("."))
